...
**IMPORTANT** *This plugin is no longer in active development or support.  You are free to download the ZIP file and use it on your WordPress site.  If you have questions, you can use the [Github Issues](https://github.com/TrevorMills/formidable-plus/issues) page and I will try to help.  No automatic updates will be provided.*
