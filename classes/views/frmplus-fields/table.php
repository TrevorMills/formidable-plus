...
<a class="frmplus-add-row" id="frmplus-add-row-<?php echo $field['id']; ?>" href="javascript:add_row(<?php echo $field['id']; ?>)"><?php echo apply_filters('frmplus_text_add_row','Add Row',$field); ?> <img style="vertical-align:middle" src="<?php echo FRMPLUS_IMAGES_URL ?>/duplicate.png" alt="New Row" title="New Row" border="0"></a> 	
<?php endif; ?>
</div>